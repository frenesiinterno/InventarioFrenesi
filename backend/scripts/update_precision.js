...
async function updatePrecision() {
    try {
        ...
        console.log('Actualizando tabla materias_primas...');
        await db.query("ALTER TABLE `materias_primas` MODIFY `stock_actual` DECIMAL(15,6) NOT NULL DEFAULT 0.000000");
        console.log('materias_primas actualizada.');
